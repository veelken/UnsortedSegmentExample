...
import onnxruntime
import argparse
from UnsortedSegmentExample_fixed import UnsortedSegmentExample_fixed
from torch.nn.parallel import DataParallel
import platform
from torch.onnx.verification import find_mismatch
##from verification import find_mismatch
...
if __name__ == "__main__":
    ...
    for segment_id in range(num_segments):
        ...
        if args.mode == "sum":
            ...
            raw_expected_output.append([ sum[component] / count for component in range(len(raw_data[idx])) ])
        else:
    ...
    torch_model = UnsortedSegmentExample_fixed(args.mode, segment_ids, num_segments)
    print(" ...Done.")
